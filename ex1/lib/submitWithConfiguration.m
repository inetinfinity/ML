...
function response = submitParts(conf, email, token, parts_)
...
function body = makePostBody(conf, email, token, parts_)
...
function showFeedback(parts_, response)
  fprintf('== \n');
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function submissionUrl_ = submissionUrl()
  submissionUrl_ = 'https://www-origin.coursera.org/api/onDemandProgrammingImmediateFormSubmissions.v1';
end
